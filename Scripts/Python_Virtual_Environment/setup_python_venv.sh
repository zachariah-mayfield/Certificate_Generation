...
# Set variables
PROJECT_PATH_NAME="Certificate_Generation"
VENV_PATH="$HOME/GitHub/$PROJECT_PATH_NAME/.venv"
REQ_FILE="$HOME/GitHub/$PROJECT_PATH_NAME/requirements.txt"
...
# ### Run this command: source ~/GitHub/Main/Certificate_Generation/.venv/bin/activate